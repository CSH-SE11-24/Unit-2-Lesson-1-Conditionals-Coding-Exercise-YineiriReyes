...
let user =prompt("whats your age")
let age=18;
if(user>=18){
...
let numberOne=prompt("enter a numbers")
numberOne=parseInt(numberOne)
let numberTwo=prompt("enter another numers")
numberTwo=parseInt(numberTwo)
if(numberOne>numberTwo){
  console.log("The firts numer is greater than the second number");
}else if(numberOne<numberTwo){
  console.log("your first number is less than your second number");
  
}else if(numberOne == numberTwo){
  console.log("your first numer is equal to your second number")
}
